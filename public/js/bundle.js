                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'POST',
                            url: 'http://127.0.0.1:3000/api/v74/users/login',
                            data: {
                              email: email,
                              password: password,
                            },
                    ...
                    while (1) {
                      switch ((_context2.prev = _context2.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'GET',
                            url: 'http://127.0.0.1:3000/api/v74/users/logout',
                          });
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          url =
                            type === 'password'
                              ? 'http://127.0.0.1:3000/api/v74/users/updateMyPassword'
                              : 'http://127.0.0.1:3000/api/v74/users/updateMe';
                          _context.next = 4;
                          return (0, _axios.default)({
                            method: 'PATCH',
                            url: url,
